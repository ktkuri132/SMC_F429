...
void bsp_usart_3_inti(uint32_t baudrate)
{
    ...
    // 配置串口引脚
    bsp_gpio_init(GPIOD, SYS_GPIO_PIN8, SYS_GPIO_MODE_AF, SYS_GPIO_OTYPE_PP, SYS_GPIO_SPEED_FAST, SYS_GPIO_PUPD_PU);
    bsp_gpio_init(GPIOD, SYS_GPIO_PIN9, SYS_GPIO_MODE_AF, SYS_GPIO_OTYPE_PP, SYS_GPIO_SPEED_FAST, SYS_GPIO_PUPD_PU);

    // 配置串口AF
    bsp_gpio_af_set(GPIOD, SYS_GPIO_PIN8, 7);
    bsp_gpio_af_set(GPIOD, SYS_GPIO_PIN9, 7);
...
/*
    ...
    PC11 RX
*/
void bsp_usart_4_inti(uint32_t baudrate)
{
    // 使能串口时钟和GPIOA时钟
...
/*
    ...
    PD2 RX
*/
void bsp_usart_5_inti(uint32_t baudrate)
{
    // 使能串口时钟和GPIOA时钟
