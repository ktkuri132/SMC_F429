...
#define MPU6050							//闂備浇娉曢崰鎰板几婵犳艾绠柣鎴ｅГ閺呮悂鏌￠崒妯衡偓鏍偓姘秺閺屻劑鎮㈤崨濠勪紕闂佸綊顥撻崗姗€寮幘璇叉闁靛牆妫楅璺好归敐鍛仴闁轰焦鎹囬幆宀勵敃閵堝棛鏆犻柡澶婄墢閸嬫挾鈧艾缍婇弻銊╂偄閸涘﹦浼勯梺褰掝棑閸忔﹢寮幘璇叉闁靛牆妫楅璺衡槈閹惧墎妲籔U6050
#define MOTION_DRIVER_TARGET_MSP430		//闂備浇娉曢崰鎰板几婵犳艾绠柣鎴ｅГ閺呮悂鏌￠崒妯衡偓鏍偓姘秺閺屻劑鎮㈤崨濠勪紕闂佸綊顥撻崗姗€寮幘璇叉闁靛牆妫楅鍫曟⒑鐠恒劌鏋戦柡瀣煼楠炲繘鎮滈懞銉︽闂佸搫鍊堕崐鏍偓姘炬嫹,闂備浇娉曢崰鎰板几婵犳艾绠柣鎴ｅГ閺呮悂鏌￠崒妯衡偓鏍偓姘辩搳SP430闂備浇娉曢崰鎰板几婵犳艾绠柣鎴ｅГ閺呮悂鏌￠崒妯衡偓鏍偓姘秺閺屻劑鎮㈤崨濠勪紕闂佺懓鍤栭幏锟�(闂備浇娉曢崰鎰板几婵犳艾绠梺鍨儛濡插姊虹捄銊ユ瀾闁哄顭烽獮蹇曠矙绾般帩32F1)
...
//}
#define log_i 	printf	//闂備浇娉曢崰鎰板几婵犳艾绠€瑰嫭婢樼粊顏堟⒑鐠恒劌鏋戦柡瀣煼楠炲繘鏌ㄧ€ｂ晝绀€
#define log_e  	printf	//闂備浇娉曢崰鎰板几婵犳艾绠€瑰嫭婢樼粊顏堟⒑鐠恒劌鏋戦柡瀣煼楠炲繘鏌ㄧ€ｂ晝绀€
...
//////////////////////////////////////////////////////////////////////////////////
//闂備浇娉曢崰鎰板几婵犳艾绠柣鎴ｅГ閺呮悂鏌熼幁鎺戝姢婵炲牊鍨跺蹇涙倷椤掆偓椤忓爼姊虹捄銊ユ灆妞ゆ洜濞€閺屽牓濡搁埡鍌涙闂佸搫鍊堕崐鏍偓姘炬嫹 
//////////////////////////////////////////////////////////////////////////////////	 
//闂備浇娉曢崰鎰板几婵犳艾绠柣鎴ｅГ閺呮悂鏌￠崒妯衡偓鏍偓姘秺閺屻劑鎮㈤崨濠勪紕闂佺懓鍢查崲鑼躲亹瑜旈弻銊╂偄閸涘﹦浼勯梺鐟板槻閸㈡煡顢楅悢鍝モ枙闁绘ê宕埢蹇涙⒑鐠恒劌鏋旈柣鎿冨亰閺佹劘绠涢弬娆句紦闂佸搫鐗滄禍顏堝极閹捐妫橀柕鍫濇椤忓爼姊虹捄銊ユ瀾闁哄顭烽獮蹇涙倻閼恒儲娅㈤梺鍝勫€堕崐鏍偓姘秺閺屻劑鎮㈤崨濠勪紕闂佸綊顥撻崗姗€寮幘鍓佺＝閺夊牆澧界粔鍫曟煙妞嬪骸鍘撮柡浣规崌瀵剟濡堕崱妤婁紦闂備浇娉曢崰鎰板几婵犳艾绠柣鎴ｅГ閺呮悂鏌￠崒妯衡偓鏍偓姘秺閺屻劑鎮㈤崨濠勪紕闂佸綊顥撻崗姗€寮幘璇叉闁靛牆妫楅鍫曟⒑鐠恒劌鏋戦柡瀣煼楠炲繘鎮滈懞銉︽闁哄鍋犲▔鏇犱焊閵娾晛绠柣鎴ｅГ閺呮悂鏌￠崒妯衡偓鏍偓姘秺閺屽懘鏁撻敓锟�
//ALIENTEK闂備浇娉曢崰鎰板几婵犳艾绠柣銈庡灠椤忕櫇TM32闂備浇娉曢崰鎰板几婵犳艾绠柣鎴ｅГ閺呮悂鏌￠崒妯衡偓鏍偓姘秺閺屻劑鎮㈤崨濠勪紕闂佸綊顥撹彠3
//MPU6050 DMP 闂備浇娉曢崰鎰板几婵犳艾绠柣鎴ｅГ閺呮悂鏌￠崒妯衡偓鏍偓姘秺閺屻劑鎮㈤崨濠勪紕闂佸綊顥撻崗姗€寮幘璇叉闁靛牆妫楅锟�	   
//闂備浇娉曢崰鎰板几婵犳艾绠柣鎴ｅГ閺呮悂鏌￠崒妯衡偓鏍偓姘秺瀹曘垽鎮㈤崗鍏兼闂佸搫鍊堕崐鏍偓姘鳖儕ALIENTEK
//闂備浇娉曢崰鎰板几婵犳艾绠柣鎴ｅГ閺呮悂鏌￠崒妯衡偓鏍偓姘秺閺屻劑鎮㈤崨濠勪紕闂佺懓鍢查崲鎻掝焽閿燂拷:www.openedv.com
//闂備浇娉曢崰鎰板几婵犳艾绠柣鎴ｅГ閺呮悂鏌￠崒妯衡偓鏍偓姘秺閺屻劑鎮㈤崨濠勪紕闂佸綊顥撻崗姗€寮幘璇叉闁靛牆妫楅锟�:2015/1/17
//闂備浇娉曢崰鏇熸叏閵堝瀚夋い鎺戝閺呮悂鏌￠崒妯衡偓鏍偓姘辩摗1.0
//闂備浇娉曢崰鎰板几婵犳艾绠梺鍨儐缂嶁偓闂備浇娉曢崰鎰板几婵犳艾绠柣鎴ｅГ閺呮悂鏌涘▎妯轰壕缂傚秴娲獮蹇涙倻閼恒儲娅㈤梺鍝勫€堕崐鏍偓姘秺閺屻劑鎮㈤崨濠勪紕闂佸綊顥撻崗妯兼閿濆鐓ラ柣鏂挎啞閻忣噣鏌熸搴″幋闁轰焦鎹囬弫鎾绘晸閿燂拷
//Copyright(C) 闂備浇娉曢崰鎰板几婵犳艾绠柣鎴ｅГ閺呮悂鏌￠崒妯衡偓鏍偓姘秺閺屻劑鎮㈤崨濠勪紕闂佸綊顥撻崗姗€寮幘璇叉闁靛牆妫楅鍫曟⒑鐠恒劌鏋戦柡瀣煼楠炲繘鎮滈懞銉︽闂佸搫鍊堕崐鏍偓姘秺閺屻劑鎮㈢粙鍨槻缂備礁顦伴崹褰掑Υ鐎ｎ喖绠柣鎴ｅГ閺呮悂鏌￠崒妯衡偓鏍偓姘秺閺屻劑鎮㈤悜姗€鐛庨梺璋庡啯鍟為悗姘秺瀹曪綁鏁撻敓锟� 2009-2019
//All rights reserved									  
////////////////////////////////////////////////////////////////////////////////// 

//q30闂備浇娉曢崰鎰板几婵犳艾绠€瑰嫭澹嗙涵鈧�,long闁哄鍋熼幆瀹璷at闂佸搫鍟悥濂稿极閹惧鐟归柕澹苯濮曢梺褰掝棑閸忔﹢寮幘璇叉闁靛牆妫楅锟�.
#define q30  1073741824.0f

//闂備浇娉曢崰鎰板几婵犳艾绠柣鎴ｅГ閺呮悂鏌￠崒妯衡偓鏍偓姘秺閺屻劑鎮㈠ú缁樺仴闂佸憡鍨崐鏍偓姘秺閺屻劑鎮㈤崨濠勪紕闂佸綊顥撻崗姗€寮幘璇叉闁靛牆妫楅鍫曟⒑鐠恒劌鏋戦柡瀣煼楠炲繘鏁撻敓锟�
static signed char gyro_orientation[9] = { 1, 0, 0,
                                           0, 1, 0,
                                           0, 0, 1};
//MPU6050闂備浇娉曢崰鎾斥枔閺囩姵瀚氱憸搴ｂ偓姘秺閺屻劑鎮㈤崨濠勪紕闂佺懓鍤栭幏锟�
//闂備浇娉曢崰鎰板几婵犳艾绠柣鎴ｅГ閺呮悂鏌￠崒妯衡偓鏍偓姘秺瀹曟劙鏁撻敓锟�:0,闂備浇娉曢崰鎰板几婵犳艾绠柣鎴ｅГ閺呮悂鏌￠崒妯衡偓鏍偓姘炬嫹
//    闂備浇娉曢崰鎰板几婵犳艾绠柣鎴ｅГ閺呮悂鏌￠崒妯衡偓鏍偓姘炬嫹,婵犮垹鐖兼禍鍫曞极閹捐妫橀柕鍫濇椤忥拷
...
//闂備浇娉曢崰鎰板几婵犳艾绠柣鎴ｅГ閺呮悂鏌￠崒妯衡偓鏍偓姘秺閺屻劑鎮㈠ú缁樺仴闂佸憡鍨崐鏍偓姘秺閺屻劑鎮㈤崨濠勪紕闂佸綊顥撻崗姗€寮幘璇叉闁靛牆妫楅鍫曟⒑鐠恒劌娅愰柟鍑ゆ嫹
...
//闂備浇娉曢崰鎰板几婵犳艾绠柣鎴ｅГ閺呮悂鏌￠崒妯衡偓鏍偓姘愁潐濞碱亪顢楅崟顒佹闂佸搫鍊堕崐鏍偓姘炬嫹
...
//闂備浇娉曢崰鎾剁懅闂佺粯鑹鹃悺銊р偓姘秺閺屻劑鎮㈤崨濠勪紕闂佺懓鍤栭幏锟�,闂佸搫鐗滄禍顏堝极閹剧粯鍎楁い鎰╁€ら弳婊堟煙閸戙倖瀚�.
...
u8 mpu_dmp_init(void)
{
	...
	u8 res=0;
	MPU_IIC_Init(); 	//闂備浇娉曢崰鎰板几婵犳艾绠€瑰嫰鍋婂妤呮⒑鐠恒劌鏋戦柡瀣煼楠炲繒绮欓姂顤夐梻浣芥硶閸犳劙寮告繝姘闁绘垼濮ら弲鎼佹煛閸屾ê鈧牜鈧熬鎷�
	if(mpu_init()==0)	//闂備浇娉曢崰鎰板几婵犳艾绠€瑰嫰鍋婂妤呮⒑鐠恒劌鏋戦柡瀣煼楠炲繒绮欓悹鎻�6050
	{	 
        
		res=mpu_set_sensors(INV_XYZ_GYRO|INV_XYZ_ACCEL);//闂備浇娉曢崰鎰板几婵犳艾绠柣鎴ｅГ閺呮悂鏌￠崒妯衡偓鏍偓姘秺閺屻劑鎮㈤崨濠勪紕闂佸綊顥撻崗姗€寮幘璇叉闁靛牆妫楅鍫曟偡閺囨氨绐旈柡浣规尰缁楃喖濡烽妸锕€娑ч梺褰掝棑閸忔﹢寮幘璇叉闁靛牆妫楅鍫曟⒑鐠恒劌鏋戦柡瀣煼楠炲繘鏁撻敓锟�
		if(res)return 1; 
		res=mpu_configure_fifo(INV_XYZ_GYRO|INV_XYZ_ACCEL);//闂備浇娉曢崰鎰板几婵犳艾绠柣鎴ｅГ閺呮悂鏌￠崒妯衡偓鏍偓姘鳖儝IFO
		if(res)return 2; 
		res=mpu_set_sample_rate(DEFAULT_MPU_HZ);	//闂備浇娉曢崰鎰板几婵犳艾绠柣鎴ｅГ閺呮悂鏌ｉ褍浜い鏇熺矒楠炲繘鎮滈懞銉︽闂佸搫鍊堕崐鏍偓姘秺閺屻劑鎮㈤崨濠勪紕闂佺懓鍤栭幏锟�
		if(res)return 3; 
		res=dmp_load_motion_driver_firmware();		 
		if(res)return 4; 
		res=dmp_set_orientation(inv_orientation_matrix_to_scalar(gyro_orientation));//闂備浇娉曢崰鎰板几婵犳艾绠柣鎴ｅГ閺呮悂鏌￠崒妯衡偓鏍偓姘秺閺屻劑鎮㈤崨濠勪紕闂佸綊顥撻崗姗€寮幘璇叉闁靛牆妫楅鍫曟⒑鐠恒劌鏋欐い顐ｎ殜瀹曟瑩濡堕崱妤婁紦闂備浇娉曢崰鎰板几婵犳艾绠柨鐕傛嫹
		if(res)return 5; 
		res=dmp_enable_feature(DMP_FEATURE_6X_LP_QUAT|DMP_FEATURE_TAP|	//闂備浇娉曢崰鎰板几婵犳艾绠柣鎴ｅГ閺呮悂鏌￠崒妯衡偓鏍偓姘鳖劊mp闂備浇娉曢崰鎰板几婵犳艾绠柣鎴ｅГ閺呮悂鏌￠崒妯衡偓鏍偓姘炬嫹
		    DMP_FEATURE_ANDROID_ORIENT|DMP_FEATURE_SEND_RAW_ACCEL|DMP_FEATURE_SEND_CAL_GYRO|
		    DMP_FEATURE_GYRO_CAL);
		if(res)return 6; 
		res=dmp_set_fifo_rate(DEFAULT_MPU_HZ);	//闂備浇娉曢崰鎰板几婵犳艾绠柣鎴ｅГ閺呮悂鏌￠崒妯衡偓鏍偓姘鳖儛MP闂備浇娉曢崰鎰板几婵犳艾绠柣鎴ｅГ閺呮悂鏌￠崒妯衡偓鏍偓姘秺閺屻劑鎮㈤崨濠勪紕闂佸綊顥撻崗姗€寮幘缁樻櫢闁跨噦鎷�(闂備浇娉曢崰鎰板几婵犳艾绠柣銈庡灣閸橀亶鏌熼钘変壕闂備浇娉曢崰鎰板几婵犳艾绠柣鎴ｅГ閺呮悂鏌ㄩ悤鍌涘200Hz)
		if(res)return 7;   
		//res=run_self_test();		//闂備浇娉曢崰鎾斥枔閺囩姵鍏滈梺鍨儏椤忥拷
	//	if(res)return 8;    
		res=mpu_set_dmp_state(1);	//婵炶揪绲藉锟犲极閹捐妫橀柕鍫濇椤忕MP
		if(res)return 9;     
	}else return 10;
	return 0;
}
...
u8 mpu_dmp_get_data(float *pitch,float *roll,float *yaw)
{
	...
	**/
	...
	{
		q0 = quat[0] / q30;	//q30闂備浇娉曢崰鎰板几婵犳艾绠€瑰嫭澹嗙涵鈧柡澶屽剱閸撶喖寮幘璇叉闁靛牆妫楅璺衡槈閹惧瓨銇濋柡浣规崌瀵剟濡堕崱妤婁紦闂備浇娉曢崰鎰板几婵犳艾绠柣鎴ｅГ閺呮悂鏌￠崒妯衡偓鏍偓姘炬嫹
		q1 = quat[1] / q30;
		q2 = quat[2] / q30;
		q3 = quat[3] / q30; 
		//闂備浇娉曢崰鎰板几婵犳艾绠柣鎴ｅГ閺呮悂鏌￠崒妯衡偓鏍偓姘秺閹娊顢曢敂鑺ユ闂佸搫鍊堕崐鏍偓姘秺閺屻劑鎮㈤崨濠勪紕闂佸綊顥撻崗姗€寮幘璇叉闁靛牆妫楅鍫曟⒑鐠恒劌娅愰柟鍑ゆ嫹/闂備浇娉曢崰鎰板几婵犳艾绠柣鎴ｅГ閺呮悂鏌￠崒妯衡偓鏍偓姘秺閺屻劑鎮ら崒娑橆伓/闂備浇娉曢崰鎰板几婵犳艾绠柣鎴ｅГ閺呮悂鏌￠崒妯衡偓鏍偓姘秺閺屻劑鎮ら崒娑橆伓
